/**
 * Example module controller that loads JSONP feeds and show them in the template
 */
define(["angular"], function (angular)
{
	/** @ngInject */
	function FeedControl($scope, $http, Routing, Localization)
	{
		...
		function load()
		{
			...
			success(function(response, status, headers, config)
			{
				...
				if(data.feed)
				{
					...
					// A more powerful way of dealing with this here: http://reactive-extensions.github.io/RxJS/
					...
					// your must reload ng-repeat this way: 
					// more info @ http://stackoverflow.com/questions/12463902/how-does-the-binding-and-digesting-work-in-angularjs
					if(!$scope.$$phase) {
						$scope.$digest();
					}
				}
